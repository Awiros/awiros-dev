...
typedef struct{
    ...
    float  loss;
    //float  avg_loss;
    float mean_avg_precision;
    float accuracy;
    float mem_used;
    float total_mem;
    float cpu_percent_used;
    float gpu_percent_used;
    float gpu_mem;
    float total_gpu_mem;
    float sample_per_sec;
    double timestamp; // based on darknet (what_time_is_it_now)
    char *model_path;
    char *test_results;
    size_t report_interval;
    int no_test_images;
    image *testing_images_results;
    int training_status;
    awiros_thread_t thread;
} awiros_report_t;
...
/* Expand only when compiling against awiros engine */
